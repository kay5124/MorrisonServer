...
{
    public class S02020Controller : Controller
    {
        #region Bacic variables
        string errStr = "";
        string funcId = "S02020";
        ...
        public ActionResult S02020()
        {
            ...
            if (selItem_lbl_cmb1 == null)
            {
                ...
                selItem_lbl_cmb1.Add(new SelectListItem { Value = "actSerial", Text = "ActSerial" });
            }

            ViewBag.selItem_lbl_cmb1 = selItem_lbl_cmb1;
            ViewBag.selItem_menuTree = Models.CmbObjMD.selItem_menuTree(ZhConfig.IsAddIndexZero.Yes, "All features", "", true);
        ...
        public ActionResult GetGridJSON(int page, int rows, string sort, string order, string lbl_cmb1, string value_cmb1, string menuTree, string value_date1, string value_date2, string value_appSysId)
        {
            ...
            try
            {
                ...
                string strCond = " where 1=1 and logDate between '" + value_date1 + "' and '" + value_date2 + "' ";

                if (!string.IsNullOrEmpty(menuTree))
                {
                    strCond += " and controllerName='" + menuTree + "' ";
                }
