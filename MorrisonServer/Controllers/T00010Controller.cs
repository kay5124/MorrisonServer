    ...
    public class T00010Controller : Controller
    {
        ...
        public ActionResult ActSingle(Models.Base.MD_S10_group actRow)//接收單筆資料方式
        {
            ...
            try
            {
                ...
                {
                    sql = " select * from T10_test where groupId='" + actRow.groupId.ToString() + "' ";
                ...
                SqlParameter[] param = {
                    ...
                    new SqlParameter("creatUser", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, 1),
                    ...
                    new SqlParameter("actUser", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, 1),
                ...
                {
                    case "A":
                        strSql.Append("insert into T10_test (groupId,groupName,memo,statusId,creatUser,creatTime) values (@groupId,@groupName,@memo,@statusId,@creatUser,@creatTime)");
                        operStatusId = "30";
                        break;
                    case "M":
                        strSql.Append("update T10_test set groupName=@groupName,statusId=@statusId,memo=@memo,actUser=@actUser,actTime=@actTime where groupId=@groupId");
                        operStatusId = "40";
                        break;
                }
                ...
                {
                    itemObject.Add("actUser", "展輝測試");
                    itemObject.Add("actTime", dtNow.ToString());
                }
                else // "A"
                {
                    itemObject.Add("creatUser", "展輝測試");
        ...
        public ActionResult DeleteSingle(string pks)
        {
            ...
            try
            {
                ...
                strSql.Clear();
                strSql.Append("update T10_test set statusId='30' where groupId=@groupId");
