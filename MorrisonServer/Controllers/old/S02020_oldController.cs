...
{
    public class S02020_oldController : Controller
    {
        #region Bacic variables
        string errStr = "";
        string funcId = "S02020_old";
        ...
        // GET: S02020_old
        public ActionResult S02020_old()
        {
            ...
            if (selItem_lbl_cmb1 == null)
            {
                ...
                selItem_lbl_cmb1.Add(new SelectListItem { Value = "actSerial", Text = "登入序號" });
            }

            ViewBag.selItem_lbl_cmb1 = selItem_lbl_cmb1;
            ViewBag.selItem_menuTree = Models.CmbObjMD.selItem_menuTree(ZhConfig.IsAddIndexZero.Yes, "所有功能", "", true);
