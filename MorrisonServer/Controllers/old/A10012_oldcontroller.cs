...
{
    public class A10012_old_oldController : Controller
    {
        #region Bacic variables
        string errStr = "";
        string resultCode = "10";
        string operStatusId = "20";
        string funcId = "A10012_old";
        ...
        #endregion
        // GET: A10012_old
        public ActionResult A10012_old()
        {
            ...
            if (selItem_lbl_cmb2 == null)
            {
                ...
                selItem_lbl_cmb2.Add(new SelectListItem { Value = "userName", Text = "使用者密碼" });
            }
            ViewBag.selItem_lbl_cm2 = selItem_lbl_cmb2;
        ...
        #region Control_GetGridJSON
        public ActionResult GetGridJSONDetail(int page, int rows, string sort, string order, string appGroupId, string lbl_cmb2, string value_cmb2)
        {
            Models.ZhWebClass_AngusV1.UserData userData = Models.ZhWebClass_AngusV1.UserHelper.GetUserData();
            JObject jo = new JObject();
            ...
            try
            {
                ...
                DataTable tbl_QueryData1 = ZhClass.SqlTool.GetDataTable(ZhConfig.GlobalSystemVar.StrConnection1, strSql.ToString(), "spU_A10012_old");
                tmpStrSql.AppendLine(strSql.ToString());

                strSql.Clear();
                strSql.Append("spU_" + funcId + "Count '" + appGroupId + "'" + tmpStr);
                DataTable tbl_QueryData2 = ZhClass.SqlTool.GetDataTable(ZhConfig.GlobalSystemVar.StrConnection1, strSql.ToString(), "spU_A10012_oldCount");
                tmpStrSql.AppendLine(strSql.ToString());
                ...
                jo.Add("rows", ja);
                jo.Add("total", tbl_QueryData2.Rows[0][0].ToString());
            }
            catch (Exception ex)
            {
                resultCode = "01";
