    ...
    public class S01030_oldController : Controller
    {
        ...
        public ActionResult GetGridJSON(int page, int rows, string sort, string order, string value_groupId)
        {
            ...
            try
            {
                ...
                strSql.Append("spU_S01030_old '" + value_groupId + "','" + ((page - 1) * rows + 1).ToString() + "','" + page * rows + "'");
